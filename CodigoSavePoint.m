...
EV.WheelRadius = 0.30; 
EV.GearRatio = 8.89;
EV.NormalForce = (EV.Mass*9.81)/4;   %[N]
EV.BatteryVoltage = 72;  %[V]
...
MTR.Torque2 = [9 17 24 29 33 36 39 40 43 35 29 24 21 17 15 13 12 10];
MTR.MaxTorque2 = 45;    %[n.m]
